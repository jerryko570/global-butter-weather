...
브랜드·이름·기존 작업물 모두 이나래가 만든 것이고, 이번 작업은 그것을 버리는 리부트가 아니라 **기존의 감각을 살려 다시 시작하는 것**이다. 역할은 **이나래 = 감각**(무엇이 좋은지, 왜 이래야 하는지를 정한다), **홍설아 = 그것을 푸는 방법**(기술적 구현과 정돈)으로 나뉜다.
...
- **외부 접점** — 인스타그램 `@butterweather_`와 네이버 스마트스토어가 있었으나 2025년 6월 이후 멈춰 있다. 이어 쓸지 새로 열지 미정.
