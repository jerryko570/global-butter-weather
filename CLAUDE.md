...
**이나래의 감각(판단)을 파는 브랜드**, 버터웨더. 고객이 사는 이유는 물건의 기능이 아니라 "이게 왜 이래야 하는지"에 동의하기 때문이다.
...
- **무엇을 만들어 파는가** — 비즈공예·헤나타투가 후보지만 미확정. 지금 우선순위는 물건이 아니라 **브랜딩·컨셉 구성**이다.
- **브랜드 이름의 뜻** · **외부 접점(사용자가 처음 만나는 곳)**
